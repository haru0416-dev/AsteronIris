...
| `providers/` | `Provider` trait | LLM provider factory + secret scrubbing |
...
| `gateway/` | Axum HTTP server | Pairing, webhooks, autosave (64KB body, 30s timeout) |
...
| `skillforge/` | Skill pipeline | Discovery, evaluation, integration |

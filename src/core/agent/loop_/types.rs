...
#[derive(Debug, Clone)]
pub(in crate::core::agent) struct RuntimeMemoryWriteContext {
    pub(in crate::core::agent) entity_id: String,
    pub(in crate::core::agent) policy_context: TenantPolicyContext,
}
...
impl RuntimeMemoryWriteContext {
    ...
    pub(in crate::core::agent) fn enforce_write_scope(&self) -> Result<()> {
        self.policy_context

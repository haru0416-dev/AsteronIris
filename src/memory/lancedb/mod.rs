...
use super::types::{
    BeliefSlot, ForgetMode, ForgetOutcome, MemoryCategory, MemoryEvent, MemoryEventInput,
...
#[cfg(test)]
mod tests {
    use super::super::embeddings::DeterministicEmbedding;
    use super::super::types::MemoryLayer;
    ...
    async fn lancedb_name_and_health() {
        ...
        let embedder = Arc::new(DeterministicEmbedding::new(8));

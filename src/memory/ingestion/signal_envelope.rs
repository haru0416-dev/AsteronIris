    ...
    fn apply_rule_based_classification(&mut self) {
        ...
        if contains_any(
            ...
            &[
                ...
                "token",
                "secret",
                "\u{500b}\u{4eba}\u{60c5}\u{5831}",
                "\u{4f4f}\u{6240}",
                "\u{96fb}\u{8a71}\u{756a}\u{53f7}",
            ],
        ) {
        ...
        if contains_any(
            ...
            &[
                ...
                "compliance",
                "regulation",
                "\u{5229}\u{7528}\u{898f}\u{7d04}",
                "\u{30b3}\u{30f3}\u{30d7}\u{30e9}\u{30a4}\u{30a2}\u{30f3}\u{30b9}",
            ],
        ) {
...
fn infer_topic(content_lower: &str, source_kind: SourceKind) -> &'static str {
    ...
    if contains_any(
        content_lower,
        &["price", "market", "stocks", "\u{682a}", "\u{76f8}\u{5834}"],
    ) {
        return "market";
    }

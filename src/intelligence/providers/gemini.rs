...
impl GeminiProvider {
    ...
    fn build_gemini_tools(
        tools: &[crate::intelligence::tools::traits::ToolSpec],
    ...
    async fn chat_with_tools_stream_impl(
        ...
        use crate::intelligence::providers::streaming::StreamEvent;
...
mod tests {
    ...
    use crate::intelligence::providers::gemini_types::CandidateContent;

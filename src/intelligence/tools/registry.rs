use crate::intelligence::tools::middleware::{
    ExecutionContext, MiddlewareDecision, ToolMiddleware,
};
use crate::intelligence::tools::traits::{ActionIntent, Tool, ToolResult, ToolSpec};
...
mod tests {
    use super::*;
    use crate::intelligence::tools::middleware::{ExecutionContext, SecurityMiddleware};
    use crate::security::{
